...
let character = {
  ...
  function generateCharacter(name) {
    ...
    newCharacter.battle = function (otherCharacter) {
      ...
      console.log(
        `Character ${this.name} attacked Character ${otherCharacter.name} with ${this.specialAbility}. ${otherCharacter.name}'s health dropped from ${initialHealth} to ${otherCharacter.health}.`
      );
    };
    return newCharacter;
  }
