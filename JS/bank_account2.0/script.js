/**
 * DOCU: Simplified Bank Account Manager without date-based limits
 * Mikhael C. Gadiz
 * done in around 3 hours
 */
function BankAccountManager() {
    ...
    /**
     * Function that handles the deposit process
     * this also filters unwanted value
     */
    ...
    /**
     * function that handles withdrawal
     * this will check the inputs and the remaining balance
     */
